...
- Assigns higher analytical weight to reliable voters
...
- Predicts possible final outcome using trend analysis
...
-Backend:Serverless Functions (AWS Lambda),REST APIs

-Database:DynamoDB

-AI & Analytics

1) Statistical analysis (entropy, trends)

2) Reliability-based weighting

3) Rule-based + LLM-assisted explanation generation
